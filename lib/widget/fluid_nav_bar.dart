...
class _FluidNavBarState extends State<FluidNavBar> with TickerProviderStateMixin {
        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: _buildButtons() as List<Widget>,
            ),
          ),
        ],
      ),
  ...
  List<FluidNavBarButton?> _buildButtons() {
    ...
    List<FluidNavBarButton> buttons =
        List.generate(icons.length, (i) => FluidNavBarButton(icons[i], _selectedIndex == i, () => _handlePressed(i)));
  ...
  void _handlePressed(int index) {
    ...
    _yController!.value = 1.0;
    _xController!
        .animateTo(_indexToPosition(index) / MediaQuery.of(context).size.width, duration: Duration(milliseconds: 620));
    Future.delayed(
